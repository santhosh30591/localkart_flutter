...
import 'package:localkart/pages/Dashboard/DayTypes/moreDetails/job_more_details.dart';
...
class JobList extends StatefulWidget {
  ...
  JobList({Key? key, required this.roots}) : super(key: key);
...
class _JobList extends State<JobList> {
  ...
  getSetvicesList(inputs) async {
    ...
    var responces = await HttpClients(
      context,
    ).httpServicesTyepe("joblist", inputs);
    try {
      setState(() {
        _isLoading = false;
      });
      ...
      try {
        ...
        if (datas['errorCode'] == 0) {
          print("sandy array list size " + datas.toString());
          setState(() {
          ...
          : RichText(
              text: TextSpan(
                ...
                children: <TextSpan>[
                  ...
                  TextSpan(
                    text: ' posts new job. Are you sure want to $title',
                                ...
                                Container(
                                  ...
                                  child: Row(
                                    children: <Widget>[
                                      ...
                                      Text(
                                        '+ ${result.result![index].count.toString()} Job',
                                        style: TextStyle(
                                          color: app_theam,
                                          // fontWeight: FontWeight.bold,
                                          fontSize: 14,
