...
import 'package:localkart/pages/Dashboard/DayTypes/moreDetails/flash_more_details.dart';
...
class FleshSale extends StatefulWidget {
  dynamic roots;
  String magasaleId;

  FleshSale({Key? key, required this.roots, required this.magasaleId})
    : super(key: key);

  @override
  _FleshSale createState() => _FleshSale();
}

class _FleshSale extends State<FleshSale> {
  @override
  void initState() {
    result.errorCode = 1;
    loadingdetails();
  ...
  loadingdetails() async {
    ...
    Map<String, Object> inputs = {
      ...
      "megasalesIndexId": "" + widget.magasaleId.toString(),
    };
  ...
  getSetvicesList(inputs) async {
    ...
    var responces = await HttpClients(
      context,
    ).httpServicesTyepe("megasaleslist", inputs);
    try {
      setState(() {
        _isLoading = false;
      });
      ...
      try {
        ...
        print("magal sale list " + responce);
                  ...
                  Container(
                    ...
                    child: Row(
                      children: <Widget>[
                        ...
                        result.result![index].isSubscribed!.toString() == "1"
                            ? InkWell(
                                child: Container(
                                ...
                                onTap: () {
                                  ShowSubscribeLocal(context, index);
                                },
                              )
                            : InkWell(
                                child: Container(
                          ...
                          onTap: () {
                            shareServicesDetails(
                              '${result.result![index].name.toString()}'
                                  ...
                                  ' To ' +
                                  result.result![index].toDate.toString(),
                              "Download LocalKart App Now https://bit.ly/3Bo6WNb",
                            );
                          },
                        ),
                      ],
                          ...
                          child: InkWell(
                            ...
                            onTap: () {
                              Navigator.of(context).push(
                                MaterialPageRoute(
                                  builder: (context) => FlashSaleMoreDetails(
                                    result: result,
                                    indexs: index,
                                  ),
                                ),
