...
class JobMoreDetails extends StatefulWidget {
  ...
  @override
  _JobMoreDetails createState() => _JobMoreDetails();
}

class _JobMoreDetails extends State<JobMoreDetails> {
  ...
  loadingServiceDetails() async {
    ...
    print(
      servicesMain.result!.length.toString() +
          " and sandy post " +
    ...
    var responces = await HttpClients(
      context,
    ).httpServicesTyepe("viewjobpostdetails", inputs);
    try {
      setState(() {
        _isLoading = false;
      });
      ...
      try {
        ...
        print("sandy details - " + responce.toString());
        ...
        try {
          if (datas['errorCode'].toString() == "0") {
            ...
            try {
              ...
              print(
                "service images loading success- " +
